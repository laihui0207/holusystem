...
<display:table name="documentationList" class="table table-condensed table-striped table-hover" requestURI=""
               id="documentationList" export="true" pagesize="25">
