...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.huivip.holu.service.impl.PasswordTokenManager#generateRecoveryToken(com.huivip.holu.model.User)
     */
    @Override
    ...
    /**
     * @see com.huivip.holu.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.huivip.holu.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.huivip.holu.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
