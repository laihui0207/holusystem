...
@Controller
@RequestMapping("/summaryTotals*")
public class SummaryTotalController {
    private SummaryTotalManager summaryTotalManager;
    ...
    throws Exception {
        ...
        try {
            model.addAttribute(summaryTotalManager.search(query, SummaryTotal.class));
        } catch (SearchException se) {
            model.addAttribute("searchError", se.getMessage());
            model.addAttribute(summaryTotalManager.getAll());
        }
        return model;
    }
}
